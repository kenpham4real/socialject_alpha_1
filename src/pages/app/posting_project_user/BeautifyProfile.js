    ...
    <div className="page">
        ...
        <div className="container-BeautifyProfile">
                ...
                <div className="view-text-input-beautifyProfile">
                        ...
                        <Select options = {options} className="select" placeholder="Location *" />

                        <input className='input-text-beautifyProfile'
                            type='text'
            ...
            <div >
                <button onClick={()=> props.history.push('/finishCreate')} className="container-continue">
