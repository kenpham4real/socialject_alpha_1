...
const AddActivityModal = (props) => {
  ...
  const _onAddActivity = () => {
    dispatch(
      _activityActions._addActivity_ppu(
        projectId,
        uuid_v4(),
        activityName,
        activityDescription,
    ...
    <div className="add-activity-container">
      <div className="add-activity--form-container">
        <div className="add-activity-titles">
          <p className="add-activity--title">Create your activity</p>
          <p className="add-activity--subtitle">What are you going to do?</p>
        </div>
              ...
              <FcCalendar
                ...
                onClick={() => {
                  ...
                  localStorage.setItem(
                    "AddActivity",
                    JSON.stringify(dataAddActivity)
                  );
                }}
